...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260506082410_attendance_management")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.ClassCourse", b =>
                {
                    ...
                    b.Property<bool>("IsPracticalRequired")
                        .HasColumnType("boolean");

                    b.Property<bool>("IsTheoryRequired")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Domain.StudentAttendance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateOnly>("AttendanceDateEn")
                        .HasColumnType("date");

                    b.Property<string>("AttendanceDateNp")
                        .IsRequired()
                        .HasMaxLength(20)
                    ...
                    b.HasIndex("Status", "AttendanceDateEn");

                    b.HasIndex("StudentEnrollmentId", "AttendanceDateEn")
                        .IsUnique()
                        .HasFilter("\"IsDeleted\" = false");

                    b.HasIndex("StudentId", "AcademicYearId");

                    b.HasIndex("AcademicYearId", "ClassSectionId", "AttendanceDateEn");

                    b.HasIndex("StudentEnrollmentId", "AttendanceDateEn", "IsDeleted");
            ...
            modelBuilder.Entity("Domain.StudentEnrollment", b =>
                {
                    ...
                    b.HasIndex("AcademicYearId", "ClassSectionId", "IsActive", "IsDeleted");
            ...
            modelBuilder.Entity("Domain.Teacher", b =>
                {
                    ...
                    b.Property<string>("JoiningDateEn")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("JoiningDateNp")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Domain.TeacherAttendance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("AcademicYearId", "AttendanceDateEn");

                    b.HasIndex("Status", "AttendanceDateEn");

                    b.HasIndex("TeacherId", "AcademicYearId");

                    b.HasIndex("TeacherId", "AcademicYearId", "AttendanceDateEn")
                        .IsUnique()
                        .HasFilter("\"IsDeleted\" = false");
            ...
            modelBuilder.Entity("Domain.TeacherClassSection", b =>
                {
                    ...
                    b.HasIndex("AcademicYearId", "ClassSectionId", "CourseId", "IsDeleted");

                    b.HasIndex("AcademicYearId", "ClassSectionId", "IsClassTeacher", "IsActive", "IsDeleted");
            ...
            modelBuilder.Entity("Domain.TeacherExperience", b =>
                {
                    ...
                    b.Property<string>("SubjectOrDepartment")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
